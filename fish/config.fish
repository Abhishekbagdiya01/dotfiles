...
alias dimages-prune="docker image prune -af"
alias dvolumes-prune="docker volume prune -f"
alias dnetworks-prune="docker network prune -f"

alias Ddrive="z /run/media/abhishek/New Volume"
